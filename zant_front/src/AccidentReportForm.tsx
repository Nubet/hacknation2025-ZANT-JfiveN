...
const AccidentReportForm: React.FC = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col gap-[30px] font-['Open_Sans','Segoe_UI',Tahoma,Geneva,Verdana,sans-serif] bg-bg-main text-text-main text-base leading-normal pt-24">
